            ...
            <div class="carousel-cell">
              ...
              <?php if ($image->title() != "" || $image->author() != "" || $image->pinfo() != ""): ?>
                ...
                <div class="caption row">
                  ...
                  <div class="col-2">
                    <img src="<?php echo url('assets/images/fullscreen.svg') ?>" style="width: 35px; float: right;
     cursor: pointer;">
                  </div>
                </div>
    ...
    <div class="col-md-3 info">
      <ul>
          ...
          <li class="curator cat-mob">
            <?php if( $catalogue->cover()->isNotEmpty()): ?> <p>exhibition's catalogue</p> <?php endif ?>
